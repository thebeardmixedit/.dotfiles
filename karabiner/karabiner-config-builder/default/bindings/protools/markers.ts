...
export const markerBindings = [
    ...
    bind(
        cmd("i"),
        soundflow(
            "user:cmgnahvnh0002h7102o78pzro:cmgq3ee8y000oq310sqvgdyft#cmsichu1y0000vq232c6k2lcp",
        ),
        { description: "Pro Tools Marker: Create INTRO" },
    ),
    bind(
        opt("t"),
        soundflow(
            "user:cmgnahvnh0002h7102o78pzro:cmgq3ee8y000oq310sqvgdyft#cmsicr47h0001vq23vz5hw3lt",
        ),
        { description: "Pro Tools Marker: Create TAG" },
    ),
];
